...
load(here(data,"o1DefRingCtrls1000_1000x10_60.Rdata"))
  ...
  save(r1DefRing,file=here(data,"r1DefRing30km_60FC.Rdata"))
...
# 2 Buffer 5 km - Main specifications ####
  ...
  save(r2DefBuff,file=here(data,"r2DefBuff1000_5000_60FC.Rdata"))
  
# 5 Sensitivity analysis (Appendix) ####
    
  ## A5.1 Spillover robust estimator ####
    
    load(here(data,"o2DefBuff1000_5000_60.Rdata"))
    ...
    save(r3SpillRob,file=here(data,"r3SpillRob1000_5000_sp10000.Rdata"))

  ## A5.2 Compare different cluster thresholds ####
    load(here(data,"oADefBuff500_5000_60.Rdata"))
    ...
    save(rADefBuff500,file=here(data,"rADefBuff500_5000.Rdata"))
    
    load(here(data,"oADefBuff1500_5000_60.Rdata"))
    oADefBuff <- oADefBuff %>% filter(fcover2000 > 0.3,!is.na(size_mine))
    ...
    save(rADefBuff1500,file=here(data,"rADefBuff1500_5000.Rdata"))
    
    load(here(data,"oADefBuff3000_5000.Rdata"))
    oADefBuff <- oADefBuff %>% filter(fcover2000 > 0.3,!is.na(size_mine))
    ...
    save(rADefBuff3000,file=here(data,"rADefBuff3000_5000.Rdata"))
    
    load(here(data,"rADefBuff500_5000.Rdata"))
    ...
    load(here(data,"r2DefBuff1000_5000_60FC.Rdata"))
    ...
    load(here(data,"rADefBuff1500_5000_60.Rdata"))
    ...
    load(here(data,"rADefBuff3000_5000.Rdata"))
  ...
  ## A5.4 GFC data ####
    load(here(data,"oAGFC1000_5000.Rdata"))
    ...
    save(rAGFC,file=here(data,"rAGFC1000_5000.Rdata"))
    
    ## A5.6 TMF data ####
    
    load(here(data,"oATMF1000_5000.Rdata"))
    ...
    save(rATMF, file=here(data,"rATMF1000_5000.Rdata"))
    
    
    ## A6.1 Alternative specifications #### 
    load(here(data,"o2DefBuff1000_5000.Rdata"))
    ...
    # Rings
      ...
      load(here(data,"o1DefRingCovs1000_1000x10.Rdata"))
    ...
    #Circle
      ...
      save(r2DefBuffCov,file=here(data,"r2DefBuffCov1000_5000_60FC.Rdata"))
    ...
    ### A6.1.2 Random controls + matching ####
      ...
      save(r2DefBuffNeverTreat,file=here(data,"r2DefBuffNeverTreat1000_5000_60FC.Rdata"))
